...
# aqui se genera un archivo csv en la carpeta
#--------------------------------------------------------------------------------------
...
# aqui se genera un archivo excel de dos hojas y datos en la carpeta: ventas del csv y clientes de los datos inventados
#--------------------------------------------------------------------------------------
...
# aqui se genera un archivo json en la carpeta
#--------------------------------------------------------------------------------------
